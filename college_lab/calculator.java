...
class Calculator extends WindowAdapter implementsActionListener {
Frame f;
Label l1;
...
l1.setBounds(50, 50, 265, 40);
l1.setFont(new Font("Serif", Font.BOLD, 20));b1 = new Button("1");
...
// FOR CLOSING THE WINDOWpublic void windowClosing(WindowEvent e) {
f.dispose();
}
...
} catch (StringIndexOutOfBoundsExceptionf){
return;
}
l1.setText(z);
}
...
l1.setText("ENTERNUMBERFIRST");return;
}
if (check == 1)
xd = num1 + num2;
if (check == 2)
